...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-jbWa0-GC.mjs";
...
import { u as useWebhooks } from "./useWebhooks-QHGF7xib.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable--iZv1HqC.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-t-JDBxSC.mjs.map
