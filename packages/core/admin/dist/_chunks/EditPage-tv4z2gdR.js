...
const useWebhooks = require("./useWebhooks-3s6sEqHY.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-aAp2IhPC.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-tv4z2gdR.js.map
